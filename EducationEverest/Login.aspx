                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 myspc4">
                        <div class="form">
                            ...
                            <br />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Email" ValidationGroup="loginForm" ErrorMessage="The User Name field is required." ForeColor="Red" Style="text-align: center; margin-top: 20px" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 myspc4">
                        <div class="form">
                            ...
                            <br />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Password" ValidationGroup="loginForm" ErrorMessage="The password field is required." ForeColor="red" Style="text-align: center" />
                        </div>
                    </div>
