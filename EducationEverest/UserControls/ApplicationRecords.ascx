        ...
        <div class="panel panel-default ">
            <div class="panel-heading card_bg">
                ...
                <div class="row" style="border-top: 1px solid #d0d0d0;">
                    ...
                    <asp:LinkButton runat="server" ID="Edit"><a id='<%# "editb"+Container.ItemIndex %>' class="pull-right editbutton margin_top" onclick="edit_repeaterclick('<%# Eval("id") %>')" style="cursor: pointer;margin-right: 30px;"><b>EDIT</b></a></asp:LinkButton>
                </div>
            </div>
