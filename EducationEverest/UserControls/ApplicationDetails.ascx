        ...
        <div class="card-header card_bg">
            <div class="row text-left" style="padding-bottom: 2%">
                ...
                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                    <h4 class="card-title margin_top">
                        <div class="NormalCharacterStyle_new1 margin_left">
                            <asp:Label runat="server" ID="lbl_UniName"></asp:Label><small runat="server" id="currentStatusField" class='rejected_text pull-right'><b><asp:Label runat="server" ID="lbl_CurrentStatus01"></asp:Label></b></small>
                        </div>
                    </h4>
                    <%--<div  class="NormalCharacterStyle_new2 margin_left margin_top">BBA &nbsp;&nbsp;&nbsp; Lahore Campus &nbsp;&nbsp;&nbsp; Spring Semester &nbsp; ...</div>--%>
                    <h4 class="blue_text col-lg-12 col-md-12 col-sm-12 col-xs-12">Application ID:
                    <asp:Label ID="lbl_appID" runat="server"></asp:Label></h4>
                    <div>
                        <span class="orange_text col-lg-2 col-md-2 col-sm-2 col-xs-2">Application Date: </span><span class="panel_text col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <asp:Label runat="server" ID="lbl_LastDate"></asp:Label></span>
                        <span class="red_text col-lg-2 col-md-2 col-sm-2 col-xs-2">Last Date: </span><span class="panel_text col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <asp:Label runat="server" ID="lbl_UniDeadline"></asp:Label></span><span class="green_text col-lg-2 col-md-2 col-sm-2 col-xs-2">Status: </span><span class="panel_text col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                <asp:Label runat="server" ID="lbl_CurrentStatus"></asp:Label></span>
                    </div>
                </div>
            </div>
                ...
                <div class="card panel_shadow">
                    <a id="menu_toggle3" href="#pinfo" data-toggle="collapse" data-parent="#accordion">
                        <div class="card-header text-left" style="background: white; height: 60px;">
                            ...
                            <h4 class="card-title NormalCharacterStyle2 other_info_card_icon">
                        ...
                        <div class="panel-body" style="background: white;">
                            ...
                            <div class="row" style="padding: 2% 5% 2% 5%">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div>
                                        <asp:Label ID="StudentCNIC" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="FatherCNIC" runat="server"></asp:Label>
                                    </div>
                                    <div>
                            ...
                            <div class="row" style="padding: 2% 5% 2% 5%">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-4 col-xs-4">
                                    <div>
                                        <asp:Label ID="CurrentAddress" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="ParmanentAddress" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="phoneStudent" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="phoneFather" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="landLine" runat="server" Text="Label"></asp:Label>
                                    </div>

                                    <div>
                                        <asp:Label ID="PostalCode" runat="server" Text="Label"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body" style="background: white;">
                            ...
                            <div class="row" style="padding: 2% 5% 2% 5%">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 ">
                                    <div>
                                        <asp:Label ID="MetricBoard" runat="server"></asp:Label>
                                        <br />
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricRollNo" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricYear" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricTotalMarks" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricObtainedMarks" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricPercentage" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="MetricGrades" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="row" style="padding: 2% 5% 2% 5%">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 ">
                                    <div>
                                        <asp:Label ID="InterBoard" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterRollNo" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterYear" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterTotalMarks" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterObtainedMarks" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterPercentage" runat="server"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="InterGrades" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
