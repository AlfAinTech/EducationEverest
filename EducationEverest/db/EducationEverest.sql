...
/****** Object:  Database [EducationEverest]    Script Date: 12/22/2017 3:37:34 PM ******/
CREATE DATABASE [EducationEverest]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EducationEverest', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\EducationEverest.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'EducationEverest_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\EducationEverest_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
